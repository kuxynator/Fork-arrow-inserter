...
eInserter.hand_base_picture = empty_sheet
eInserter.hand_base_shadow = empty_sheet
eInserter.hand_closed_picture = empty_sheet
eInserter.hand_closed_shadow = empty_sheet
eInserter.hand_open_picture = empty_sheet
eInserter.hand_open_shadow = empty_sheet
-- eInserter.platform_picture.sheet = empty_sheet
