...
function this.on_player_rotated_entity(evt)
	...
	if string.match(entity.name, "%-double%-arrow$") then
	...
	elseif string.match(entity.name, "%-double%-arrow_part$") then
		...
		entity.surface.find_entity(name .. "_arr", entity.position).direction = (entity.direction + 4) % 8
	elseif string.match(entity.name, "%-arrow$") then
		--HACK: always rotate
		entity.surface.find_entity(entity.name .. "_arr", entity.position).direction = (entity.direction + 4) % 8
